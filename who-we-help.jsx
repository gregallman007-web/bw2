...
const PERSONAS = [
  {
    ...
    services:["initial-assessment","follow-up","sports-massage","acupuncture"],
  },
  {
    ...
    body:"We help older adults rebuild strength and balance, recover well after surgery, and keep doing the things they love. Sessions are paced to you, and home visits mean care can come to you when getting out is harder. Where further input is needed, we refer back to your GP with a clinic letter and liaise with our network of orthopaedic and sport & exercise medicine consultants.",
    needs:["Balance, strength & falls prevention","Post-operative recovery","Arthritis & joint pain","Staying mobile & independent"],
    services:["initial-assessment","follow-up","rehabilitation","home-visits"],
  },
  {
    ...
    services:["initial-assessment","sports-massage","rehabilitation","follow-up","acupuncture"],
  },
  {
    ...
    body:"We provide friendly, age-appropriate assessment and treatment for growth-related and sporting complaints, helping young people stay active, confident and pain-free, with parents involved every step of the way. When specialist input is needed, we refer back to your GP with a clinic letter and liaise directly with our network of paediatric and sport & exercise medicine consultants.",
    needs:["Growth-related aches & pains","Youth sporting injuries","Posture & movement confidence","Reassurance for parents"],
    services:["initial-assessment","rehabilitation","follow-up","sports-massage|Soft Tissue"],
  },
];
        ...
        <div className="persona-body">
          ...
          <div className="p-services">
            ...
            <div className="ps-chips">
              {p.services.map(entry => {
                const [slug, label] = entry.split("|");
                return (
                <a className="ps-chip" href={"service-" + slug + ".html"} key={entry}>{label || svcName(slug)}<Icon name="arrow" size={12}/></a>
                );
              })}
            </div>
          </div>
